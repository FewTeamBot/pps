...
kk = LINETCR.LINE()
ks = LINETCR.LINE()
cl.login(token="EmEPxbn6nzAwvGXB1A5d.4nf6sMUZgNnuo85fQpyGdq.g01FDoWZB2X0u4ng6v/eaT8O3rcvlarbR/Dvo/v4XHk=")
ki.login(token="EldzhWC3F0PZcrfMc0f0.avNKvVVxRvlll+ZPhY1ISa.4KmKjd94IldVaQSDj+3YREUIuPUsRHj88Cgm4SktKeo=")
kk.login(token="ElExOGZ2fFEyQJAfGoy8.F+GSL6ZLbmGekHIjVfZdca.YehqvGUSAs5d9rL0ruveXtloVafNIP9kcewwmGwLpkY=")
ks.login(token="ElnlPX1hqZl0MS7OALcb.7cH1jyIL5zjmYtd4T0EOIW.ZeRAxNAoz3vv1KWlTBEtMU0TyP3PbuAvOR1mU57zewk=")
cl.loginResult()
ki.loginResult()
kk.loginResult()
ks.loginResult()
...
admin = ["ue0d17a4a6bb31a73543bce45a8f6200d"]
...
admins = ["ue0d17a4a6bb31a73543bce45a8f6200d"]
Rx3 = ["ue0d17a4a6bb31a73543bce45a8f6200d"]
Rx2 = ["ue0d17a4a6bb31a73543bce45a8f6200d"]
Rx1 = ["ue0d17a4a6bb31a73543bce45a8f6200d"]
...
def bot(op):
    try:
        ...
        if op.type == 25:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "ue0d17a4a6bb31a73543bce45a8f6200d":
                    if "join:" in msg.text:
...
#-------------------------------------------------------------------蹴り返し
        ...
        if op.param1 in autocancel:
			OWN ="ue0d17a4a6bb31a73543bce45a8f6200d"
			if op.param2 in OWN:
				pass
			else:
				Inviter = op.param3.replace("",',')
