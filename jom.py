...
cl = LINETCR.LINE()
cl.login(token="ElMUn2pM8AHmsuDpC029.DR5c0tsZLfGgrohU0R7qkq.9j36ME7WdFFA4txCoXLFN9cHOUaZwQrdyykVOhuAVmY=")
cl.loginResult()
...
admin=["76be42d134b394580644e1eed2bed029"]
wait = {
    'contact':True,
    'autoJoin':False,
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
              ...
              if msg.toType == 2:
                ...
                wait["message"] = msg.text.replace("Comm: ","")
                cl.sendText(msg.to,"message changed")
            elif "Comm add: " in msg.text:
                wait["message"] = msg.text.replace("Comm add: ","")
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"message changed")
                else:
                ...
                if c in [""," ","\n",None]:
                    ...
                    wait["comment"] = c
                    cl.sendText(msg.to,"changed\n\n" + c)
            elif msg.text in ["ã‚³ãƒ¡ãƒ³ãƒˆ:ã‚ªãƒ³","Com on","Comment:on","è‡ªå‹•é¦–é ç•™è¨€ï¼šé–‹"]:
                if wait["commentOn"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"è¦äº†å¼€ã€‚")
            elif msg.text in ["ã‚³ãƒ¡ãƒ³ãƒˆ:ã‚ªãƒ•","Com off","Comment off","è‡ªå‹•é¦–é ç•™è¨€ï¼šé—œ"]:
                if wait["commentOn"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"è¦äº†å…³æ–­ã€‚")
            elif msg.text in ["Com1","ç•™è¨€ç¢ºèª"]:
